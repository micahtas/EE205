...
int main()
{
	...
	cout << "Printing course #1." << endl;
	c_Display(&C1);	
	cout << "Printing course #2." << endl;
        c_Display(&C2);
	cout << "Printing course #3." << endl;
        c_Display(&C3);
	cout << "Printing course #4." << endl;
        c_Display(&C4);
	cout << "Printing course #5." << endl;
        c_Display(&C5);
	...
	c_SetSection(&C5, s1);
	c_SetFocus(&C5, f3);
	cout << "Printing NEW course #5." << endl;
	c_Display(&C5);

	c_Init(&C6, r3, c2, t2, p3, f1, g3, CRN3, s1);
	cout << "Printing course #6." << endl;
	c_Display(&C6);

	cout << "Copying course #6 to course #7..." << endl;
	cout << "..." << endl;
	c_Copy(&C7, &C6);
	cout << "... Success!" << endl;
	c_Display(&C7);
