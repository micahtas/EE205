...
/*
	for(int i(0); i<a.count; i++)
	{
		...
		cout << "pstart: "<< a.Start().current << endl;
		cout << "pnext: "<< a.End().current->getnext() << endl;
		cout << "dstart: "<< a.Start().current->getdata() << endl;
		cout << "dnext: "<< a.End().current->getdata() << endl;
*/
	for(ContainerIterator it(a.Start()); it != a.End(); it++)
	{
		cout << "pstart: "<< it.current << endl;
		cout << "here" << endl;
		insert(*it);
	}
}
...
/*	
	...
	{
		cout << "beginp: "<< it.current << endl;
		cout << "begind: "<< it.current->getdata() << endl;
		cout << "nextp: "<< it.current->getnext() << endl;

		it.current = it.current->getnext();
		cout << "end travelp: "<< it.current << endl;
		cout << "end traveld: "<< it.current->getdata() << endl;
	}
	//or just
	//it.current = NULL?
*/
