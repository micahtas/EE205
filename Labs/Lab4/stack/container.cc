 ...
 */
{
	...
	{	
		Warning("Container does not exist at position.");
		return -1;
	}
	else
	{
 ...
 */
{
	...
	{
		Warning("Insert at illegal position or full");
		return;
	}
 ...
 */
{
	...
	{	
		Warning("Trying remove from illegal position");
		return -1;
	}
 ...
 */
{
	if( !valid_position(p,count-1) || isempty())
	{	
		Warning("Container: Retrieve to illegal position.");
		return;
	}
